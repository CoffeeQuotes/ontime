                                                    ...
                                                    <button class="switch-icon switch-icon-scale"
                                                        ...
                                                        <span class="switch-icon-b text-red">
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                class="icon icon-filled" width="24" height="24"
                            ...
                            <div class="col-12">
                                <div class="card card-sm">
                                    <div class="card-body">
                                        ...
                                        <div class="text-muted">Dedicated form for a category of users that will perform
                                            actions.</div>
                                        <div class="mt-4">
                                            <div class="row">
                                                <div class="col">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="divide-y-2 mt-4">
                                            <div>
                                                ...
                                                <span class="text-muted text-decoration-line-through">Implement new
                                                    designs</span>
                                            </div>
                                            <div>
                                                <!-- Download SVG icon from http://tabler-icons.io/i/check -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="divide-y-2 mt-4">
                                            <div>
                                                ...
                                                <span class="text-muted text-decoration-line-through">Find out the old
                            ...
                            <div class="col-12">
                                <div class="card card-sm">
                                    <div class="card-body">
                                        ...
                                        <div class="text-muted">Publishing industries for previewing layouts and visual
                                            <a href="#">#family</a> 🔥
                                        </div>
                                        <div class="mt-4">
                                            <div class="row">

...
<div id="profile-wrapper" class="center-50">
    <div class="profile-box">
        ...
        <div>
            <h1 id="aboutHeading" style="display: flex;"><?= $profile['firstname'] ?? '' ?>
                <?= $profile['lastname'] ?? '' ?>
                <sup class="secondary-text edit-head-icon" onclick="openModal()"><i class="fas fa-edit"></i></sup>
            </h1>
            ...
            <form id="profileForm" action="update-profile.php" method="post" enctype="multipart/form-data">
                <div id="modalFormFlex">
                    ...
                    <div class="rightSideModal">
                        ...
                        <div class="error error-middlename"></div>
                        ...
                        <input type="text" name="designation" id="designation"
                            value="<?php echo $profile['designation'] ?>" />
                        <div class="error error-designation"></div>
                    </div>
                </div>
                <div>
